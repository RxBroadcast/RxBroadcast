...
public final class TwoWaySingleSourceFifoOrderUdpBroadcastTest {
    ...
    private TwoWaySingleSourceFifoOrderUdpBroadcastTest() { /* empty */ }
    ...
    public static void main(final String[] args) throws InterruptedException, SocketException, UnknownHostException {
        ...
        final Broadcast broadcast = new UdpBroadcast<>(
            new DatagramSocket(port), destination, port, new SingleSourceFifoOrder<>(SingleSourceFifoOrder.DROP_LATE));
